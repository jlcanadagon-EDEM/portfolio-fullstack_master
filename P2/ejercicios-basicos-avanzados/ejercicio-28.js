...
Recorre la lista de álbumes y suma la duración de aquellos
cuyo género sea "Rock".

Muestra la duración total por consola.
*/
...
console.log(
  `Duración total de los álbumes de rock: ${totalRockDuration.toFixed(2)} minutos`
);