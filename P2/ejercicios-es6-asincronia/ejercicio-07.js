...
Filtra los videojuegos que pertenezcan al género RPG
y calcula la media de sus puntuaciones usando reduce().
*/
...
console.log(`Media de los videojuegos RPG: ${averageRpgScore}`);